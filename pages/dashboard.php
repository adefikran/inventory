    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="/DashboardController?type=2&nip=${nip}&name=${name}"><i class="pull-right-container"></i> Test Data </a></li>
                <li><a href="/DashboardController?type=3&nip=${nip}&name=${name}"><i class="pull-right-container"></i> Result Data </a></li>
            </ul>
        </section>
    </aside>
