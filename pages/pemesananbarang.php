...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click', '.add', function(){
            ...
            html += '<td><select name="item_category[]" class="form-control item_category" data-sub_category_id="'+count+'"><option value="">Select Category</option><?php echo fillBarang();?></select></td>';
